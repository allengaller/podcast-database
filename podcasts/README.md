...
│   ├── news/          新闻 / 时政       (5 档 · 深档 3)
│   ├── story/         罪案 / 悬疑 / 历史  (6 档 · 深档 5)
│   ├── tech/          科技 / 互联网      (11 档 · 深档 9)
└── en/                ← 英文 / 国际播客
...
> 例外:[`featured/`](./featured/) 是**置顶学习专题**目录(逐集精读指南,如《硅谷 101》《This Week in Tech》),不参与语料库校验与统计,不作为播客档存放处。
